...
/**
 * Inline SVGs rather than an icon package: lucide removed its brand marks in
 * v1 (`Github`, `Linkedin`, `Twitter` are all gone — the `X` it still exports
 * is the close/times glyph, not the logo). Brand marks should be the real
 * marks anyway, so these are the official paths on a 24x24 viewBox.
 */
