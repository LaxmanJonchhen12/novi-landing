...
import { HOW_IT_WORKS_VISUALS } from "./how-it-works-visuals";
 ...
 *
 * Each step also carries a small unboxed visual (`how-it-works-visuals.tsx`)
 * — same reasoning as the feature cards' mini visuals, but deliberately
 * without a card frame of their own, so this section still reads as
 * "connected steps," not a second card grid.
 */
    ...
    >
      ...
      >
        {howItWorksSteps.map((step, index) => {
          const Visual = HOW_IT_WORKS_VISUALS[step.visual];
          return (
            <li
              key={step.title}
              className={[
